...
async function setupAllContracts(versionDetails) {
  ...
  const EPNSCoreV1_5 = await deployContract("EPNSCoreV1_5", [], "EPNSCoreV1_5");
  deployedContracts.push(EPNSCoreV1_5)
  ...
  await EPNSCoreAdminInstance.upgrade(versionDetails.deploy.args.epnsProxyAddress, EPNSCoreV1_5.address);
  console.log(chalk.bgWhite.bold.black(`\n\t\t\t\n ✅ Contracts Upgraded  \n\t\t\t\n`))
