...
async function setupAllContracts(versionDetails) {
  ...
  const EPNSCommV1_5 = await deployContract("EPNSCommV1_5", [], "EPNSCommV1_5");
  deployedContracts.push(EPNSCommV1_5)
  ...
  console.log(chalk.bgWhite.bold.black(`\n\t\t\t\n ✅ Upgrading Contract to`), chalk.magenta(`${EPNSCommV1_5.address} \n\t\t\t\n`))
  await epnsAdminInstance.upgrade(versionDetails.deploy.args.epnsProxyAddress, EPNSCommV1_5.address);
  console.log(chalk.bgWhite.bold.black(`\n\t\t\t\n ✅ Contracts Upgraded  \n\t\t\t\n`))
