...
export default function Contract({ account, gasPrice, signer, provider, name, show, price, contractOverride }) {
  const contracts = useContractLoader(provider, contractOverride);
