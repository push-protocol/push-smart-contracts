...
export default function useContractLoader(providerOrSigner, override = null) {
      ...
      if (typeof providerOrSigner !== "undefined") {
        try {
          ...
          const newContracts = contractList.reduce((accumulator, contractName) => {
            accumulator[contractName] = loadContract(contractName, signer, override ? override[contractName] : null);
            return accumulator;
          }, {});
