...
contract GovernorBravoDelegate is GovernorBravoDelegateStorageV1, GovernorBravoEvents {
    ...
    uint256 public constant MIN_PROPOSAL_THRESHOLD = 500_000e18; // 500,000 = 0.5% of EPNS

    /// @notice The maximum setable proposal threshold
    uint256 public constant MAX_PROPOSAL_THRESHOLD = 1_000_000e18; // 1,000,000 PUSH
    ...
    /// to succeed
    uint256 public constant quorumVotes = 40_000_000e18; // 40,000,000 = 4% of EPNS
        ...
        returns (uint256)
    {
        ...
        require(
            PUSH.getPriorVotes(msg.sender, sub256(block.number, 1)) > proposalThreshold,
    ...
    function cancel(uint256 proposalId) external {
        ...
        require(
            msg.sender == proposal.proposer
                || PUSH.getPriorVotes(proposal.proposer, sub256(block.number, 1)) < proposalThreshold,
