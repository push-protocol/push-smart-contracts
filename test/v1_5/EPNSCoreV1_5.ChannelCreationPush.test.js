   ...
   describe("Testing the Base Create Channel Function", function()
      {
          ...
          it("Should revert if IF EPNSCoreV1::onlyInactiveChannels: Channel already Activated ", async function () {
            ...
            await expect(tx).to.be.revertedWith("EPNSCoreV1_5::onlyInactiveChannels: Channel already Activated")
          });
          ...
          it("Should revert Channel Type is not the ALLOWED TYPES", async function () {
            ...
            await expect(tx1).to.be.revertedWith("EPNSCoreV1_5::onlyUserAllowedChannelType: Channel Type Invalid")
            ...
            await expect(tx2).to.be.revertedWith("EPNSCoreV1_5::onlyUserAllowedChannelType: Channel Type Invalid")
          });
          ...
          it("should revert if allowance is not greater than min fees", async function(){
            ...
            await expect(tx).to.be.revertedWith("EPNSCoreV1_5::_createChannelWithPUSH: Insufficient Deposit Amount")
          });
