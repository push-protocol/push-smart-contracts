...
describe("EPNS Core Protocol Tests Channel tests", function () {
  ...
  before(async function () {
    ...
    await EPNSCoreProxy.changeAdmin(alice.address);
    ...
    await EPNSCommProxy.changeAdmin(alice.address);
  ...
  describe("Testing Channel Verification Functions for Admin", function() {
     ...
     * Should revert if EPNSCoreV1::onlyUnverifiedChannels: Channel Already Verified
     *
  ...
  //
  //         await expect(tx).to.be.revertedWith('EPNSCoreV1::onlyVerifiedChannels: Channel is Not Verified Yet');
  //     });
  //
  ...
  //
  //           await expect(tx).to.be.revertedWith('EPNSCoreV1::revokeVerificationViaChannelOwners: Caller not Verifier of the Channel');
  //       });
  //
